...
(() => {
  ...
  const stylesheet =
    ...
    // Physio8 patch: auto (was none) so a finger swipe on a photo scrolls the page on phones.
    // Pan/resize in the editor happens on .spill, which keeps touch-action:none.
